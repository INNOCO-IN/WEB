...
Synced from the canonical project root on 2026-09-04.
...
- `*.EN.dc.html` / `*.KO.dc.html` — 89 pages (incl. WS-* workshop briefs); the nav's EN/KR toggle swaps between them.
...
- `uploads/` — brief imagery (logo, workshop photos).
